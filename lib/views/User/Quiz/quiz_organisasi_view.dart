...
class QuizOrganisasiView extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child: Obx((){
                    return LinearPercentIndicator(
                      width: 370,
                      lineHeight: 18.0,
                      percent: (quizController.indexThree.value + 1)/quizController.quiz.value.organisasi.length,
                      ...
                      Container(
                        ...
                        child: Obx((){
                          return Container(
                            ...
                            child: Text(
                              quizController.quiz.value.organisasi[quizController.indexThree.value].question,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: (){quizController.handlePostSurveyThree(quizController.quiz.value.organisasi[quizController.indexThree.value].id_question);},
                    child: Text('Lanjut'),
                  ),
                )
              ],
