...
class QuizPengelolaView extends StatelessWidget {
            ...
            children: [
              Container(
                ...
                child: Obx((){
                  return LinearPercentIndicator(
                    width: 370,
                    lineHeight: 18.0,
                    percent: (quizController.indexOne.value + 1)/quizController.quiz.value.pengelola.length,
                    ...
                    Container(
                      ...
                      child: Obx((){
                        return Container(
                          ...
                          child: Text(
                            quizController.quiz.value.pengelola[quizController.indexOne.value].question,
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: (){quizController.handlePostSurveyOne(quizController.quiz.value.pengelola[quizController.indexOne.value].id_question);},
                  child: Text('Lanjut'),
                ),
              )
            ],
