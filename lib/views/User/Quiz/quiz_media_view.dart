...
class QuizMediaView extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child: Obx((){
                    return LinearPercentIndicator(
                      width: 370,
                      lineHeight: 18.0,
                      percent: (quizController.indexEight.value + 1)/quizController.quiz.value.mediapartner.length,
                      ...
                      Container(
                        ...
                        child: Obx((){
                          return Container(
                            ...
                            child: Text(
                              quizController.quiz.value.mediapartner[quizController.indexEight.value].question,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: (){quizController.handlePostSurveyEight(quizController.quiz.value.mediapartner[quizController.indexEight.value].id_question);},
                    child: Text('Lanjut'),
                  ),
                )
              ],
