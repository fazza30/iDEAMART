...
class QuizMedsosView extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child: Obx((){
                    return LinearPercentIndicator(
                      width: 370,
                      lineHeight: 18.0,
                      percent: (quizController.indexTwo.value + 1)/quizController.quiz.value.medsos.length,
                      ...
                      Container(
                        ...
                        child: Obx((){
                          return Container(
                            ...
                            child: Text(
                              quizController.quiz.value.medsos[quizController.indexTwo.value].question,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: (){quizController.handlePostSurveyTwo(quizController.quiz.value.medsos[quizController.indexTwo.value].id_question);},
                    child: Text('Lanjut'),
                  ),
                )
              ],
