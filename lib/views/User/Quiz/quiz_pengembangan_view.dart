...
class QuizPengembanganView extends StatelessWidget {
              ...
              children: [
                Container(
                  ...
                  child: Obx((){
                    return LinearPercentIndicator(
                      width: 370,
                      lineHeight: 18.0,
                      percent: (quizController.indexSix.value + 1)/quizController.quiz.value.pengembangan.length,
                      ...
                      Container(
                        ...
                        child: Obx((){
                          return Container(
                            ...
                            child: Text(
                              quizController.quiz.value.pengembangan[quizController.indexSix.value].question,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: (){quizController.handlePostSurveySix(quizController.quiz.value.pengembangan[quizController.indexSix.value].id_question);},
                    child: Text('Lanjut'),
                  ),
                )
              ],
